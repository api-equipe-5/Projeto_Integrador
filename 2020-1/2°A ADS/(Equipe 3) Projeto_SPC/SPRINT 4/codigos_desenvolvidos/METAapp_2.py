...
.dynamic_graph_container_result_MVT {
    display: grid;
    grid-template-columns: 1fr 1fr 1fr 1fr;
    grid-template-rows: 70vh 70vh 70vh 70vh 70vh;
    grid-gap: 10px;
    grid-template-areas:
                         "five five five five"
                         "six six six six"
...
.dynamic_graph_container_result_OPR {
    ...
    grid-template-rows: 70vh 70vh 70vh 70vh 70vh;
    grid-gap: 10px;
    grid-template-areas: "five five six"
                         "seven seven seven"
                         "eight eight eight"
                         "nine nine nine"
                         "ten ten ten";
...
.dynamic_graph_container_result_PGT {
    display: grid;
    grid-template-columns: 1fr 1fr 1fr 1fr;
    grid-template-rows: 70vh 50vh 70vh 70vh 70vh 70vh 70vh;
    grid-gap: 10px;
    grid-template-areas: "five five five five"
                         "six six seven seven"
                         "eight eight eight eight"
                         "nine nine nine nine"
                         "ten ten ten ten"
