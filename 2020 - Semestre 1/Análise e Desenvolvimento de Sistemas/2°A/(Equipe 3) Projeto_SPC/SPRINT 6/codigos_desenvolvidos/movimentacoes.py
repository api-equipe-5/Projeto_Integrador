        ...
        <section id="graphs">
          <div class="static_graph_container_01">
            ...
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/mvt_preenchimento.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/mvt_tab_datas.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
          ...
          <div class="dynamic_graph_container_MVT">
            <div class="graph_one">
              ...
              <div class="content">
                <iframe src=content/mvt_tipo.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="content">
                <iframe src=content/mvt_tab_correspondencia.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/mvt_unicos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/mvt_tab_sensibilidade.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
...
def resultados (relatorio, pasta, tabela_mvt, tabela_mdl):
    ...
    mvt_por_cli = [(parcela['Número de Movimentações'][x] / parcela['Número de Clientes'][x]) for x in range (len (parcela))]
    parcela['Número de Movimentações por Cliente'] = mvt_por_cli

    visualiza = parcela.replace(to_replace = 0, value = np.nan)

    visualiza = (visualiza
                    .style
                    .format({'Valor das Parcelas':"R$ {:,.2f}", 'Número de Movimentações':"{:,.0f}", 'Número de Clientes':"{:,.0f}", 'Número de Movimentações por Cliente':"{:,.2f}"}, na_rep="-")
    ...
    remessa_mvt_por_cli = parcela['Número de Movimentações'].sum() / parcela['Número de Clientes'].sum()

    #remessa_total_parcelas, remessa_total_credito, remessa_minimo_credito, remessa_num_movimentacoes, remessa_mvt_por_cli
        ...
        <section id="graphs">
          <div class="static_graph_container_02">
            <div class="graph_one">
              ...
              <div class="result_content">
                  <div class="result_value">R$ ''' + str("{:,.2f}".format(remessa_total_parcelas)) + '''</div>                
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="result_content">
                  <div class="result_value">R$ ''' + str("{:,.0f}".format(remessa_total_credito)) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="result_content">
                  <div class="result_value">R$ ''' + str("{:,.2f}".format(remessa_minimo_credito)) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="result_content">
                  <div class="result_value">''' + str("{:,.0f}".format(int(remessa_num_movimentacoes))) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_five">
              <!-- graph form -->
              <div class="head">
                <div class="title">Média do Número de Movimentações por Clientes</div>
              </div>
              <div class="result_content">
                  <div class="result_value">''' + str("{:,.2f}".format(int(remessa_mvt_por_cli))) + '''</div>
              </div>
              <!-- graph form -->
            </div>
          </div>
          <div class="dynamic_graph_container_result_MVT">
            <div class="graph_one">
              ...
              <div class="content">
                <iframe src=content/mvt_modalidades.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="content">
                <iframe src=content/mvt_tab_modalidades.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/mvt_clientes_movimentacoes.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/mvt_clientes.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_five">
              ...
              <div class="content">
                <iframe src=content/mvt_movimentacoes.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
