        ...
        <section id="graphs">
          <div class="static_graph_container_01">
            ...
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/opr_completude_sem_consorcio.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/opr_tab_datas.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
          ...
          <div class="dynamic_graph_container_MVT">
            <div class="graph_one">
              ...
              <div class="content">
                <iframe src=content/opr_tipo.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="content">
                <iframe src=content/opr_tab_correspondencia.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/opr_unicos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/opr_tab_sensibilidade.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
        ...
        <section id="graphs">
          <div class="static_graph_container_02">
            <div class="graph_one">
              ...
              <div class="result_content">
                  <div class="result_value">R$ ''' + str("{:,.2f}".format(total_vlr_contratado)) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="result_content">
                  <div class="result_value">R$ ''' + str("{:,.2f}".format(total_vlr_saldo_devedor)) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="result_content">
                  <div class="result_value">''' + str("{:,.0f}".format(int(total_qtd_pcl))) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="result_content">
                  <div class="result_value">''' + str("{:,.0f}".format(int(total_qtd_opr))) + '''</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_five">
              <!-- graph form -->
              <div class="head">
                <div class="title">Média do Número de Operações por Clientes</div>
              </div>
              <div class="result_content">
                  <div class="result_value">''' + str("{:,.2f}".format(int(total_opr_por_cli))) + '''</div>                
              </div>
              <!-- graph form -->
            </div>
          </div>
          <div class="dynamic_graph_container_result_OPR">
            <div class="graph_one">
              ...
              <div class="content">
                <iframe src=content/opr_soma_opr_por_mdl.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="content">
                <iframe src=content/opr_grafico_valor_consorcio.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/opr_tab_modalidades.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/opr_clientes_parcelas.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_five">
              ...
              <div class="content">
                <iframe src=content/opr_soma_cliente_por_mdl.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_six">
              ...
              <div class="content">
                <iframe src=content/opr_soma_pcl_por_mdl.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
