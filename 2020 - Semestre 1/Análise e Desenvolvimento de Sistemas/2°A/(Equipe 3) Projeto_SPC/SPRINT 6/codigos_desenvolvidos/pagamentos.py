...
def write_to_html_file_maior(df, title='', filename='out.html'):
    result = '''
<html>
<head>
<style>
...
def validacao (relatorio, pasta, tabela_pgt, tabela_mdl, tabela_fnt):
    ...
    visualiza = (sensibilidade_review
                    .style
                    .applymap(destaque))
    write_to_html_file_maior(visualiza, title='', filename=pasta + "/pgt_tab_sensibilidade.html")
    visualiza
    ...
    write_to_html_file_maior(visualiza, title='', filename=pasta + "/pgt_tab_correspondencia.html")
    visualiza
    ...
    write_to_html_file_maior(visualiza, title='', filename=pasta + "/pgt_tab_datas.html")
    visualiza
        ...
        <section id="graphs">
          <div class="static_graph_container_01">
            ...
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/pgt_preenchimento.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_datas.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
          ...
          <div class="dynamic_graph_container_MVT">
            <div class="graph_one">
              ...
              <div class="content">
                <iframe src=content/pgt_tipo.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="head">
                ...
                <div class="paragraph">Porcentagem de campos preenchidos comparando a existência dos dados encontrados
                  com as tabelas de origem</div>
              </div>
              <div class="content">
                <iframe src=content/pgt_tab_correspondencia.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=content/pgt_unicos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_sensibilidade.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
      ...
      <div class="container-content-col">
        <div class="static_graph_container_03">
          <div class="graph_one">
            ...
            <div class="result_content">
                <div class="result_value">R$ ''' + str("{:,.2f}".format(remessa_total_pagamentos)) + '''</div>              
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_two">
            ...
            <div class="result_content">
                <div class="result_value">''' + str("{:,.0f}".format(int(remessa_num_vencidos))) + '''</div>              
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_three">
            ...
            <div class="result_content">
                <div class="result_value">''' + str("{:,.0f}".format(int(remessa_num_pagamentos))) + '''</div>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_four">
            <!-- graph form -->
            <div class="head">
              <div class="title">Média do Número de Pagamentos por Clientes</div>
            </div>
            <div class="result_content">
                <div class="result_value">''' + str("{:,.2f}".format(int(remessa_pgt_por_cli))) + '''</div>
            </div>
            <!-- graph form -->
          </div>
        </div>
        <div class="dynamic_graph_container_result_PGT">
          <div class="graph_one">
            ...
            <div class="content">
              <iframe src=content/pgt_vencidos_totais.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_two">
            ...
            <div class="content">
              <iframe src=content/pgt_tab_modalidades.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_three">
            ...
            <div class="content">
              <iframe src=content/pgt_tab_vencidos.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_four">
            ...
            <div class="content">
              <iframe src=content/pgt_pagamentos_vencidos.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_five">
            ...
            <div class="content">
              <iframe src=content/pgt_total_pagamentos.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_six">
            ...
            <div class="content">
              <iframe src=content/pgt_clientes_num_pagamentos.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_seven">
            ...
            <div class="content">
              <iframe src=content/pgt_clientes.html></iframe>
            </div>
            <!-- graph form -->
          </div>
          <div class="graph_eight">
            ...
            <div class="content">
              <iframe src=content/pgt_num_pagamentos.html></iframe>
            </div>
            <!-- graph form -->
          </div>
        </div>
...
def indice_em_dia_geral (relatorio, pasta, tabela_pgt, tabela_mdl):
    ...
    tabela_valores = tabela_valores.rename_axis('Modalidades', axis='columns')
    ...
    tabela_valores_pct = tabela_valores_pct.rename_axis('Modalidades', axis='columns')
    ...
    tabela_clientes = tabela_clientes.rename_axis('Modalidades', axis='columns')
    ...
    tabela_clientes_pct = tabela_clientes_pct.rename_axis('Modalidades', axis='columns')
    ...
    tabela_num_pagamentos = tabela_num_pagamentos.rename_axis('Modalidades', axis='columns')
    ...
    tabela_num_pagamentos_pct = tabela_num_pagamentos_pct.rename_axis('Modalidades', axis='columns')
        ...
        <section id="graphs">
          <div class="dynamic_graph_container_index_MOD">
            <div class="graph_one">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">''' + str(int(media_valores_pct)) + '''%</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">R$ ''' + str("{:,.2f}".format(media_valores)) + '''</div>                
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">''' + str(int(media_acuracia)) + '''%</div>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_pct_indice_dia_valores.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_five">
              ...
              <div class="content">
                <iframe src=content/pgt_indice_dia_valores.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_six">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_indice_dia_valores.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_seven">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">''' + str(int(media_clientes_pct)) + '''%</div>                
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_eight">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">''' + str("{:,.0f}".format(int(media_clientes))) + '''</div>                
              </div>
              <!-- graph form -->
            </div>
            ...
            <div class="graph_ten">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_pct_indice_dia_clientes.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_eleven">
              ...
              <div class="content">
                <iframe src=content/pgt_indice_dia_clientes.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_twelve">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_indice_dia_clientes.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_thirteen">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">''' + str(int(media_num_pagamentos_pct)) + '''%</div>                 
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_fourteen">
              ...
              <div class="indexMOD_content">
                  <div class="indexMOD_value">''' + str("{:,.0f}".format(int(media_num_pagamentos))) + '''</div>                 
              </div>
              <!-- graph form -->
            </div>
            ...
            <div class="graph_sixteen">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_pct_indice_dia_num_pagamentos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_seventeen">
              ...
              <div class="content">
                <iframe src=content/pgt_indice_dia_num_pagamentos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_eighteen">
              ...
              <div class="content">
                <iframe src=content/pgt_tab_indice_dia_num_pagamentos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
...
def indice_pgt_por_cli (relatorio, pasta, tabela_pgt, tabela_mdl):
    print ("Gerando Relatório do Índice do Número de Pagamentos por Cliente...")
    ...
    # # Gerando uma tabela geral dos pagamentos por faixa de valores
    ...
    faixas = [0,250,500,750,1000,
              2500,5000,7500,10000,
              25000,50000,75000,100000,
              250000,500000,750000,1000000,
              2500000,5000000,7500000,10000000,
              25000000,50000000,75000000,100000000,
              250000000,df.VLR_PGT_FAT.max()]

    faixas_valores_review = df.groupby(pd.cut(df.VLR_PGT_FAT, faixas)).sum()


    # In[11]:


    tabela = faixas_valores_review[['VLR_PGT_FAT','QTD_CLI_CAD_POS','QTD_PGT']]
    tabela = tabela.rename(columns={'VLR_PGT_FAT': 'Totais dos Pagamentos'})
    tabela = tabela.reset_index()

    pgt_por_cli = [(tabela.QTD_PGT[x] / tabela.QTD_CLI_CAD_POS[x]) for x in range (len (tabela))]
    tabela['Número de Pagamentos por Cliente'] = pgt_por_cli

    tabela = tabela.rename(columns={'VLR_PGT_FAT': 'Faixa de Valores de Pagamentos', 'QTD_CLI_CAD_POS': 'Número de Clientes',
                                    'QTD_PGT': 'Número de Pagamentos'})

    tabela.set_index('Faixa de Valores de Pagamentos', inplace=True)
    tabela = tabela.rename_axis('Faixa de Valores de Pagamentos', axis='columns')

    esquerda = ["{:,.2f}".format(x) for x in tabela.index.categories.left]
    direita = ["{:,.2f}".format(x) for x in tabela.index.categories.right]
    novo_indice = [f"({esquerda[x]}, {direita[x]}]" for x in range (len(tabela))]

    tabela['Faixa de Valores de Pagamentos'] = novo_indice
    tabela.set_index('Faixa de Valores de Pagamentos', inplace=True)
    tabela.index.name = None
    ...
    visualiza = (visualiza
                    .style
                    .format({'Totais dos Pagamentos':"R$ {:,.2f}", 'Número de Pagamentos':"{:,.0f}", 'Número de Clientes':"{:,.0f}", 'Número de Pagamentos por Cliente':"{:,.2f}"}, na_rep="-")
                    .highlight_null(null_color='#F2F200')
                    .apply(highlight_max)
                    .apply(highlight_min))
    write_to_html_file_maior(visualiza, title='', filename=pasta + "/pgt_indice_pgt_por_cli_tab_faixas_valores.html")
    visualiza
    ...
    data = [go.Bar(x=tabela.index,
                   y=tabela['Número de Pagamentos por Cliente'],
                   marker=dict(color='#3749E9')
                  )]
    ...
    fig.write_html(pasta + "/pgt_indice_pgt_por_cli_faixas_valores.html")
...
<head>
  <meta charset="UTF-8">
  <meta name="author" content="git: diegosilva89, ud21">
  <title>METAlitcs - Faixas de Valores</title>
  <link rel="stylesheet" href="content/style.css">
  <link rel="icon" href="content/favicon.png">
</head>
  ...
  <main>
    ...
    <div class="container">
      ...
      <div class="container-content-col">
        <div class="container-content-col">
          <section id="graphs">
            <div class="dynamic_graph_container_index_FaixaVAL">
              <div class="graph_one">
                <!-- graph form -->
                <div class="head">
                  <div class="title">Número de Pagamentos por Clientes</div>
                  <div class="paragraph">Por faixa de valores de Pagamentos</div>
                </div>
                <div class="content">
                  <iframe src=content/pgt_indice_pgt_por_cli_faixas_valores.html></iframe>
                </div>
                <!-- graph form -->
              </div>
              <div class="graph_two">
                <!-- graph form -->
                <div class="head">
                  <div class="title">Tabela de Pagamentos por Faixas de Valores</div>
                  <div class="paragraph">Totais de pagamentos, número de clientes, número de pagamentos e número de pagamentos por cliente</div>
                </div>
                <div class="content">
                  <iframe src=content/pgt_indice_pgt_por_cli_tab_faixas_valores.html></iframe>
                </div>
                <!-- graph form -->
              </div>
            </div>
    ...
    f = open(relatorio + '/index_FaixaVal.html','w', encoding='utf-8')
    f.write(html_string)
    f.close()
    
    print (f"O Relatório do Índice do Número de Pagamentos por Cliente foi criado com sucesso!")
