        ...
        <section id="graphs">
          <div class="static_graph_container_01">
            ...
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=pags/fnt_preenchimento.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=pags/fnt_tab_datas.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
          ...
          <div class="dynamic_graph_container_FNT">
            <div class="graph_one">
              ...
              <div class="content">
                <iframe src=pags/fnt_tipo.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_two">
              ...
              <div class="content">
                <iframe src=pags/fnt_tab_sensibilidade.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_three">
              ...
              <div class="content">
                <iframe src=pags/fnt_unicos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_four">
              ...
              <div class="content">
                <iframe src=pags/fnt_cnpjs_validos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_five">
              ...
              <div class="content">
                <iframe src=pags/fnt_cnpjs_unicos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_six">
              ...
              <div class="content">
                <iframe src=pags/fnt_cnpjs_caracteres.html></iframe>
              </div>
              <!-- graph form -->
            </div>
            <div class="graph_seven">
              ...
              <div class="content">
                <iframe src=pags/fnt_nomes_unicos.html></iframe>
              </div>
              <!-- graph form -->
            </div>
          </div>
