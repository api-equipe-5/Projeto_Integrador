...
cod_identificacao_luz int,

codigo_cliente_conta float(20),
...
foreign key (id_cliente_conta) references cliente(id_cli),
foreign key (id_clienteconsumo_conta) references cliente(id_cli),
primary key(id_conta)
)default charset = utf8;

-- Criando a tabela Imovel:
create table pi_grupo6.imovel (
id_imovel int not null auto_increment,
id_cliente_conta int not null,
tipo_imovel varchar(30) not null,
identificacao_imovel int not null,
uf_imovel varchar(2) not null,
cidade_imovel varchar(30) not null,
bairro_imovel varchar(30) not null,
rua_imovel varchar(30) not null,
num_imovel int(6) not null,
complemento_imovel varchar(40) not null,
cep_imovel varchar(15) not null,
...
-- Buscar
select * from imovel
join cliente on id_cli = id_cliente_conta

-- Cadastrar
INSERT INTO IMOVEL (id_imovel, id_cliente_conta)
