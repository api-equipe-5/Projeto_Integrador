...
public class DocumentacaoController {
    public Set<Class<?>> getClasses() {
        ...
        resources.add(TipoUsuarioController.class);
        return resources;
    }
    ...
    public Response getJsonSwagger() throws JsonProcessingException, UnknownHostException, NoSuchAlgorithmException,
            UnsupportedEncodingException {
        Swagger swagger = new Reader(new Swagger()).read(getClasses());
        swagger.setBasePath("/spring-app/controller");
        setInfo(swagger);
    ...
    private void setInfo(Swagger swagger) {
        Info info = new Info();
        info.setTitle("Documentação API com Swagger");
