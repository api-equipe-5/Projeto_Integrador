                ...
                <div className="main">
                    <div className="createVeiculo">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div>
                                <label>Chassi</label>
                                <InputMask type="text" mask="*****************" value={chassi} formatChars={inputRules} onChange={e => setChassi(e.target.value)} />
                            </div>
                            <div>
                                <label>Tipo da Placa</label>
                                <select onChange={e => setTipoPlaca(e.target.value)} > 
                                    <option value="ANTIGA" defaultValue >Placa Antiga</option>
